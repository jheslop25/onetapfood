        ...
        input: {
          items: [{
            ...
            tracking: {
              ...
              display_name: "Banana",
              item_card_impression_id: "e3d6d615-aa59-4c92-b002-b936c953d5c1",
              cartQty: 0,
              qtyDiff: 1,
              source3: null
            },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      meals: null,
      spoonApi: "b2408b5b91424531aa6d57aa58070853"
    };
  },
  methods: {
    createMealPlan: function createMealPlan() {
      //a function to get a meal plan from spoon
      var SpoonacularApi = __webpack_require__(/*! spoonacular_api */ "./node_modules/spoonacular_api/dist/com.spoonacular.client/index.js");

      var api = new SpoonacularApi.DefaultApi();
      var apiKey = 'apiKey=' + this.spoonApi;
      var q = "steak and eggs"; // {String} The recipe search query.
      ...
      api.searchRecipesComplex(apiKey, q, callback);
    }
  },
  mounted: function mounted() {},
  props: {},
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        { staticClass: "m-3 p-3" },
        [
          _c("v-card-title", [_vm._v("Add Items to Cart")]),
          _vm._v(" "),
          _c("v-btn", { on: { click: _vm.addToCart } }, [_vm._v("Add")])
        ],
        1
      )
    ],
